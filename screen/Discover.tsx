...
const Discover = () => {
  ...
  const [bl_lat, setBl_lat] = useState<string | null | undefined | number>(null);
  const [bl_lng, setBl_lng] = useState<string | null | undefined | number>(null);
  const [tr_lat, setTr_lat] = useState<string | null | undefined | number>(null);
  const [tr_lng, setTr_lng] = useState<string | null | undefined | number>(null);
